...
objects = ['Mercury', 'HST', 'jupiter', 'ENCELADUS', 'fake']
results = [({'object': 'Mercury',
             'orbits': 'Sun',
             'radius': 2440.53*u.km,
             'mass': 3.30103e+23*u.kg,
             'a': 0.387098*u.au,
             'e': 0.20563016180610344,
             'tilt': 0*u.deg,
           ...
           ({'object': 'Jupiter',
             ...
             'type': 'Planet',
             'naifid': 599,
             'lambda_tilt': 200.8*u.deg,
             'alpha_tilt': 9.5*u.deg,
             'lambda_offset': 149*u.deg,
             'delta_offset': 0.12*71492*u.km,
             '_solar_frame': 'JUPITERSOLAR',
           ...
           ({'object': 'Enceladus',
             ...
             'a': 238419.91474058*u.km,
             'e': 0.0063517872142336545,
             'tilt': 0.009*u.deg,
             'rotperiod': 31.344*u.h,
             'orbperiod': 1.37461662*u.d,
             'GM':-7.21036669*u.km**3/u.s**2,
             'GM_center': -37931206.23436167 * u.km**3/u.s**2,
             'satellites': None,
             'type': 'Moon',
             'naifid': 602,
             '_solar_frame': 'ENCELADUSSOLAR',
