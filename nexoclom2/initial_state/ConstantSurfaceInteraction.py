...
class ConstantSurfaceInteraction(InputClass):
    """Surface interaction with constant sticking coefficient and accomodation factor
    ...
    def __init__(self, sparam: (dict, Document)):
        ...
        self.__name__ = 'ConstantSurfaceInteraction'
